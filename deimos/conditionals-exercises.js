...
console.log("The value of the user confirm is: " + userConfirm);

if (userConfirm){
	var userInput = prompt("Please enter a number.");

	console.log("User prompt input: " + userInput);

	var isNumber = !isNaN(userInput);

	console.log("Is number check: " + isNumber);
	...
	if(isNumber){
		...
		console.log("Number is even check: " + isEven);

		var evenMessage = (isEven) ? "Number is even" : "number is odd";
		alert(evenMessage);

		alert(userNumber + 100);

		var posNegMessage = (userNumber >= 0) ? "number is positive" : "number is negative";
		alert(posNegMessage);
...
var finalAmount = calculateTotal(luckyNumber, totalBillPrompt).toFixed(2)


alert("You total bill is: $" + finalAmount );